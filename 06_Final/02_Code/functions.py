...
#def7
def api_ieee(config_api, config_query):
    '''
    ...
    return df_api_ieee.to_json(orient='index', indent=4)

#########################################################################

#def8
def api_elsevier(config_api, config_query):
    '''
    ...
    return df_api_elsevier.to_json(orient='index', indent=4)